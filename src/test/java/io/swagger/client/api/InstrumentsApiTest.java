...
public class InstrumentsApiTest {
    ...
    private InstrumentsApi api;
    private final String symbol = "BTCUSDQ";

    @Before
    public void setUp(){
        ApiClient client = Configuration.getDefaultApiClient();

        ApiKeyAuth apiKeyAuth = (ApiKeyAuth) client.getAuthentication("ApiKey");
        apiKeyAuth.setApiKey("212578ed-6ad0-489f-9b9a-3a07662a0e42");

        ApiKeyAuth passPhrase = (ApiKeyAuth) client.getAuthentication("PassPhraseKey");
        passPhrase.setApiKey("qume");

        ApiKeyAuth signature = (ApiKeyAuth) client.getAuthentication("SignatureKey");
        signature.setApiKey("b89e04821c5496a56cb7d5dc4752a134");

        api = new InstrumentsApi(client);
    }
     ...
     */
    @Test
    public void getAllMarketStatsTest() throws ApiException {
        OrderbookGetAllMarketStatsResponse response = api.getAllMarketStats();
     ...
     */
    @Test
    public void getCurrentIndexPriceTest() throws ApiException {
        PricesGetCurrentIndexPriceResponse response = api.getCurrentIndexPrice(symbol);
        Assert.assertNotNull(response);
    }
    /**
     ...
     */
    @Test
    public void getCurrentMarkPriceTest() throws ApiException {
        PricesGetCurrentMarkPriceResponse response = api.getCurrentMarkPrice(symbol);
        Assert.assertNotNull(response);
    }
    /**
     ...
     */
    @Test
    public void getFundingRateTest() throws ApiException {
        PricesGetFundingRateResponse response = api.getFundingRate(symbol);
        Assert.assertNotNull(response);
    }
    /**
    ...
    public void getMarketTest() throws ApiException {
        MarketGetMarketResponse response = api.getMarket(symbol);
        Assert.assertNotNull(response);
    }
    /**
     ...
     */
    @Test
    public void getOrdersForMarketTest() throws ApiException {
        OrderbookGetOrdersForMarketResponse response = api.getOrdersForMarket(symbol);
        Assert.assertNotNull(response);
    }
}
