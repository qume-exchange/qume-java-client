...
public class WalletsApiTest {
     ...
     */
    @Test
    public void getPositionsByUserTest() throws ApiException {
        String asset = null;
        WalletGetPositionsResponse response = api.getPositionsByUser(asset);
     ...
     */
    @Test
    public void getWalletByUserTest() throws ApiException {
        String asset = null;
        WalletWalletState response = api.getWalletByUser(asset);
    ...
    public void getWalletsTest() throws ApiException {
        WalletWallets response = api.getWallets();
