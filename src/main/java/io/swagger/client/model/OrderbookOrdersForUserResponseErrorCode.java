...
/**
 * Gets or Sets orderbookOrdersForUserResponseErrorCode
 */
@JsonAdapter(OrderbookOrdersForUserResponseErrorCode.Adapter.class)
public enum OrderbookOrdersForUserResponseErrorCode {
  _UNUSED_("_unused_"),
  OK("OK");

  private String value;

  OrderbookOrdersForUserResponseErrorCode(String value) {
    this.value = value;
  }
  ...
  public static OrderbookOrdersForUserResponseErrorCode fromValue(String text) {
    for (OrderbookOrdersForUserResponseErrorCode b : OrderbookOrdersForUserResponseErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookOrdersForUserResponseErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookOrdersForUserResponseErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookOrdersForUserResponseErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookOrdersForUserResponseErrorCode.fromValue(String.valueOf(value));
    }
  }
}
