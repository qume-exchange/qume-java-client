...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class WalletContract {
  ...
  private Double maintenanceMargin = null;

  @SerializedName("notional")
  private String notional = null;
  public WalletContract id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WalletContract initialMargin(Double initialMargin) {
  ...
  **/
  ...
  public WalletContract maintenanceMargin(Double maintenanceMargin) {
  ...
  **/
  ...
  public WalletContract notional(String notional) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WalletContract walletContract = (WalletContract) o;
    return Objects.equals(this.id, walletContract.id) &&
        Objects.equals(this.initialMargin, walletContract.initialMargin) &&
        Objects.equals(this.maintenanceMargin, walletContract.maintenanceMargin) &&
        Objects.equals(this.notional, walletContract.notional);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, initialMargin, maintenanceMargin, notional);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletContract {\n");
