...
/**
 * Gets or Sets orderbookOrderType
 */
@JsonAdapter(OrderbookOrderType.Adapter.class)
public enum OrderbookOrderType {
  _ORDERTYPE_UNUSED_("_OrderType_unused_"),
  LIMIT("LIMIT"),
  ...
  OrderbookOrderType(String value) {
    this.value = value;
  }
  ...
  public static OrderbookOrderType fromValue(String text) {
    for (OrderbookOrderType b : OrderbookOrderType.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookOrderType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookOrderType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookOrderType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookOrderType.fromValue(String.valueOf(value));
    }
  }
}
