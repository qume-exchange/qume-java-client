...
/**
 * Gets or Sets orderbookStopOrderTrigger
 */
@JsonAdapter(OrderbookStopOrderTrigger.Adapter.class)
public enum OrderbookStopOrderTrigger {
  _STOPORDERTRIGGER_UNUSED_("_StopOrderTrigger_unused_"),
  ...
  OrderbookStopOrderTrigger(String value) {
    this.value = value;
  }
  ...
  public static OrderbookStopOrderTrigger fromValue(String text) {
    for (OrderbookStopOrderTrigger b : OrderbookStopOrderTrigger.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookStopOrderTrigger> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookStopOrderTrigger enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookStopOrderTrigger read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookStopOrderTrigger.fromValue(String.valueOf(value));
    }
  }
}
