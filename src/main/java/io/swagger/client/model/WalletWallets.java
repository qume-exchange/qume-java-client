...
import io.swagger.client.model.WalletWalletSummary;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class WalletWallets {

  @SerializedName("wallets")
  private List<WalletWalletSummary> wallets = null;
  public WalletWallets wallets(List<WalletWalletSummary> wallets) {
    this.wallets = wallets;
    return this;
  }

  public WalletWallets addWalletsItem(WalletWalletSummary walletsItem) {
    if (this.wallets == null) {
      this.wallets = new ArrayList<WalletWalletSummary>();
    }
  ...
  **/
  @Schema(description = "")
  public List<WalletWalletSummary> getWallets() {
    return wallets;
  }
  public void setWallets(List<WalletWalletSummary> wallets) {
    this.wallets = wallets;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    WalletWallets walletWallets = (WalletWallets) o;
    return Objects.equals(this.wallets, walletWallets.wallets);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(wallets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletWallets {\n");
