...
import io.swagger.client.model.OrderbookGetOrdersForMarketResponseErrorCode;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class OrderbookGetOrdersForMarketResponse {

  @SerializedName("status")
  private OrderbookGetOrdersForMarketResponseErrorCode status = null;

  @SerializedName("orders")
  private List<OrderbookOrder> orders = null;
  public OrderbookGetOrdersForMarketResponse status(OrderbookGetOrdersForMarketResponseErrorCode status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public OrderbookGetOrdersForMarketResponseErrorCode getStatus() {
    return status;
  }
  public void setStatus(OrderbookGetOrdersForMarketResponseErrorCode status) {
    this.status = status;
  }
  public OrderbookGetOrdersForMarketResponse orders(List<OrderbookOrder> orders) {
    this.orders = orders;
    return this;
  }

  public OrderbookGetOrdersForMarketResponse addOrdersItem(OrderbookOrder ordersItem) {
    if (this.orders == null) {
      this.orders = new ArrayList<OrderbookOrder>();
    }
  ...
  **/
  @Schema(description = "")
  public List<OrderbookOrder> getOrders() {
    return orders;
  }
  public void setOrders(List<OrderbookOrder> orders) {
    this.orders = orders;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    OrderbookGetOrdersForMarketResponse orderbookGetOrdersForMarketResponse = (OrderbookGetOrdersForMarketResponse) o;
    return Objects.equals(this.status, orderbookGetOrdersForMarketResponse.status) &&
        Objects.equals(this.orders, orderbookGetOrdersForMarketResponse.orders);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(status, orders);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderbookGetOrdersForMarketResponse {\n");
