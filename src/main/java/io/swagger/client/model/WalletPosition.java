...
import io.swagger.client.model.WalletContract;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class WalletPosition {

  @SerializedName("id")
  private String id = null;

  @SerializedName("contract")
  private WalletContract contract = null;

  @SerializedName("order_margin")
  private String orderMargin = null;

  @SerializedName("initial_margin")
  private String initialMargin = null;
  ...
  public WalletPosition id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WalletPosition contract(WalletContract contract) {
  ...
  **/
  @Schema(description = "")
  public WalletContract getContract() {
    return contract;
  }
  public void setContract(WalletContract contract) {
    this.contract = contract;
  }
  public WalletPosition orderMargin(String orderMargin) {
  ...
  **/
  ...
  public WalletPosition initialMargin(String initialMargin) {
  ...
  **/
  ...
  public WalletPosition size(String size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public WalletPosition entryValue(String entryValue) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WalletPosition walletPosition = (WalletPosition) o;
    return Objects.equals(this.id, walletPosition.id) &&
        Objects.equals(this.contract, walletPosition.contract) &&
        Objects.equals(this.orderMargin, walletPosition.orderMargin) &&
        Objects.equals(this.initialMargin, walletPosition.initialMargin) &&
        Objects.equals(this.size, walletPosition.size) &&
        Objects.equals(this.entryValue, walletPosition.entryValue);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, contract, orderMargin, initialMargin, size, entryValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletPosition {\n");
