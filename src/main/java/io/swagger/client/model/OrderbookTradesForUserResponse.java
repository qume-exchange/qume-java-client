...
import io.swagger.client.model.OrderbookTrade;
import io.swagger.client.model.OrderbookTradesForUserResponseErrorCode;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class OrderbookTradesForUserResponse {

  @SerializedName("status")
  private OrderbookTradesForUserResponseErrorCode status = null;

  @SerializedName("trades")
  private List<OrderbookTrade> trades = null;
  public OrderbookTradesForUserResponse status(OrderbookTradesForUserResponseErrorCode status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public OrderbookTradesForUserResponseErrorCode getStatus() {
    return status;
  }
  public void setStatus(OrderbookTradesForUserResponseErrorCode status) {
    this.status = status;
  }
  public OrderbookTradesForUserResponse trades(List<OrderbookTrade> trades) {
    this.trades = trades;
    return this;
  }

  public OrderbookTradesForUserResponse addTradesItem(OrderbookTrade tradesItem) {
    if (this.trades == null) {
      this.trades = new ArrayList<OrderbookTrade>();
    }
  ...
  **/
  ...
  public void setTrades(List<OrderbookTrade> trades) {
    this.trades = trades;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    OrderbookTradesForUserResponse orderbookTradesForUserResponse = (OrderbookTradesForUserResponse) o;
    return Objects.equals(this.status, orderbookTradesForUserResponse.status) &&
        Objects.equals(this.trades, orderbookTradesForUserResponse.trades);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(status, trades);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderbookTradesForUserResponse {\n");
