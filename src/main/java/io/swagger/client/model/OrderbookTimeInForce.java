...
/**
 * Gets or Sets orderbookTimeInForce
 */
@JsonAdapter(OrderbookTimeInForce.Adapter.class)
public enum OrderbookTimeInForce {
  _TIMEINFORCE_UNUSED_("_TimeInForce_unused_"),
  ...
  OrderbookTimeInForce(String value) {
    this.value = value;
  }
  ...
  public static OrderbookTimeInForce fromValue(String text) {
    for (OrderbookTimeInForce b : OrderbookTimeInForce.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookTimeInForce> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookTimeInForce enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookTimeInForce read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookTimeInForce.fromValue(String.valueOf(value));
    }
  }
}
