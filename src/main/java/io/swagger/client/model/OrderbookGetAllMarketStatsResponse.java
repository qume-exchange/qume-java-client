...
import io.swagger.client.model.OrderbookMarketStats;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class OrderbookGetAllMarketStatsResponse {

  @SerializedName("marketStats")
  private List<OrderbookMarketStats> marketStats = null;
  public OrderbookGetAllMarketStatsResponse marketStats(List<OrderbookMarketStats> marketStats) {
    this.marketStats = marketStats;
    return this;
  }

  public OrderbookGetAllMarketStatsResponse addMarketStatsItem(OrderbookMarketStats marketStatsItem) {
    if (this.marketStats == null) {
      this.marketStats = new ArrayList<OrderbookMarketStats>();
    }
    this.marketStats.add(marketStatsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<OrderbookMarketStats> getMarketStats() {
    return marketStats;
  }
  public void setMarketStats(List<OrderbookMarketStats> marketStats) {
    this.marketStats = marketStats;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    OrderbookGetAllMarketStatsResponse orderbookGetAllMarketStatsResponse = (OrderbookGetAllMarketStatsResponse) o;
    return Objects.equals(this.marketStats, orderbookGetAllMarketStatsResponse.marketStats);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(marketStats);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderbookGetAllMarketStatsResponse {\n");
    
    sb.append("    marketStats: ").append(toIndentedString(marketStats)).append("\n");
    sb.append("}");
    return sb.toString();
  }
