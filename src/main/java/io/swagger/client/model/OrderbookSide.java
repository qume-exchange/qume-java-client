...
/**
 * Gets or Sets orderbookSide
 */
@JsonAdapter(OrderbookSide.Adapter.class)
public enum OrderbookSide {
  _SIDE_UNUSED_("_Side_unused_"),
  BUY("BUY"),
  SELL("SELL");
  ...
  public static OrderbookSide fromValue(String text) {
    for (OrderbookSide b : OrderbookSide.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookSide> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookSide enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookSide read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookSide.fromValue(String.valueOf(value));
    }
  }
}
