...
import io.swagger.client.model.OrderbookOrdersForUserResponseErrorCode;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class OrderbookOrdersForUserResponse {

  @SerializedName("status")
  private OrderbookOrdersForUserResponseErrorCode status = null;

  @SerializedName("orders")
  private List<OrderbookOrder> orders = null;
  public OrderbookOrdersForUserResponse status(OrderbookOrdersForUserResponseErrorCode status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public OrderbookOrdersForUserResponseErrorCode getStatus() {
    return status;
  }
  public void setStatus(OrderbookOrdersForUserResponseErrorCode status) {
    this.status = status;
  }
  public OrderbookOrdersForUserResponse orders(List<OrderbookOrder> orders) {
    this.orders = orders;
    return this;
  }

  public OrderbookOrdersForUserResponse addOrdersItem(OrderbookOrder ordersItem) {
    if (this.orders == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OrderbookOrdersForUserResponse orderbookOrdersForUserResponse = (OrderbookOrdersForUserResponse) o;
    return Objects.equals(this.status, orderbookOrdersForUserResponse.status) &&
        Objects.equals(this.orders, orderbookOrdersForUserResponse.orders);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderbookOrdersForUserResponse {\n");
