...
import io.swagger.client.model.WalletPositionMap;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-04T14:35:49.897-03:00[America/Sao_Paulo]")public class WalletGetPositionsResponse {

  @SerializedName("positions")
  private List<WalletPositionMap> positions = null;
  public WalletGetPositionsResponse positions(List<WalletPositionMap> positions) {
    this.positions = positions;
    return this;
  }

  public WalletGetPositionsResponse addPositionsItem(WalletPositionMap positionsItem) {
    if (this.positions == null) {
      this.positions = new ArrayList<WalletPositionMap>();
    }
  ...
  **/
  @Schema(description = "")
  public List<WalletPositionMap> getPositions() {
    return positions;
  }
  public void setPositions(List<WalletPositionMap> positions) {
    this.positions = positions;
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    WalletGetPositionsResponse walletGetPositionsResponse = (WalletGetPositionsResponse) o;
    return Objects.equals(this.positions, walletGetPositionsResponse.positions);
  }
  ...
  public String toString() {
    ...
    sb.append("class WalletGetPositionsResponse {\n");
