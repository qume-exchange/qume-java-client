...
/**
 * Gets or Sets orderbookGetOrdersForMarketResponseErrorCode
 */
@JsonAdapter(OrderbookGetOrdersForMarketResponseErrorCode.Adapter.class)
public enum OrderbookGetOrdersForMarketResponseErrorCode {
  _UNUSED_("_unused_"),
  OK("OK");

  private String value;

  OrderbookGetOrdersForMarketResponseErrorCode(String value) {
    this.value = value;
  }
  ...
  public static OrderbookGetOrdersForMarketResponseErrorCode fromValue(String text) {
    for (OrderbookGetOrdersForMarketResponseErrorCode b : OrderbookGetOrdersForMarketResponseErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookGetOrdersForMarketResponseErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookGetOrdersForMarketResponseErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookGetOrdersForMarketResponseErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookGetOrdersForMarketResponseErrorCode.fromValue(String.valueOf(value));
    }
  }
}
