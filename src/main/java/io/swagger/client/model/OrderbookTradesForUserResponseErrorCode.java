...
/**
 * Gets or Sets orderbookTradesForUserResponseErrorCode
 */
@JsonAdapter(OrderbookTradesForUserResponseErrorCode.Adapter.class)
public enum OrderbookTradesForUserResponseErrorCode {
  _UNUSED_("_unused_"),
  OK("OK");

  private String value;

  OrderbookTradesForUserResponseErrorCode(String value) {
    this.value = value;
  }
  ...
  public static OrderbookTradesForUserResponseErrorCode fromValue(String text) {
    for (OrderbookTradesForUserResponseErrorCode b : OrderbookTradesForUserResponseErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderbookTradesForUserResponseErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderbookTradesForUserResponseErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderbookTradesForUserResponseErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderbookTradesForUserResponseErrorCode.fromValue(String.valueOf(value));
    }
  }
}
