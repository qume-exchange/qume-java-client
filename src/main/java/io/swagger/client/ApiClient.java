...
import io.swagger.client.auth.SignatureAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.qume.io/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKey", new ApiKeyAuth("header", "X-QUME-API-KEY"));
        authentications.put("PassPhraseKey", new ApiKeyAuth("header", "X-QUME-PASSPHRASE"));
        authentications.put("SignatureKey", new SignatureAuth("header", "X-QUME-SIGNATURE"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.qume.io/v1
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        updateParamsForAuth(authNames, queryParams, headerParams, body, path);
     ...
     */
    public void updateParamsForAuth(String[] authNames, List<Pair> queryParams, Map<String, String> headerParams, Object body, String path) {
        for (String authName : authNames) {
            Authentication auth = authentications.get(authName);
            if (auth == null) throw new RuntimeException("Authentication undefined: " + authName);
            auth.applyToParams(queryParams, headerParams, body, path);
        }
    }
