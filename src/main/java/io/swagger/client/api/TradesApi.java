...
import io.swagger.client.model.OrderbookTradesForUserResponse;
...
public class TradesApi {
    ...
    /**
     * Build call for getTradesForUser
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getTradesForUserCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getTradesForUserValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getTradesForUserCall(progressListener, progressRequestListener);
        return call;
     ...
     * 
     * @return OrderbookTradesForUserResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public OrderbookTradesForUserResponse getTradesForUser() throws ApiException {
        ApiResponse<OrderbookTradesForUserResponse> resp = getTradesForUserWithHttpInfo();
        return resp.getData();
    }
     ...
     * GET - Returns all historical trades for user
     * 
     * @return ApiResponse&lt;OrderbookTradesForUserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OrderbookTradesForUserResponse> getTradesForUserWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getTradesForUserValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<OrderbookTradesForUserResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * GET - Returns all historical trades for user (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getTradesForUserAsync(final ApiCallback<OrderbookTradesForUserResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTradesForUserValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OrderbookTradesForUserResponse>(){}.getType();
